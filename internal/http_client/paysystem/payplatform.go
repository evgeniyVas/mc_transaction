...
func NewPayPlatformService(operations operations.ClientService) *PayService {
	return &PayService{
...
func (p *PayService) CreateTransaction(ctx context.Context, amount float64) (*paymodels.TransactionCreateResp, error) {
...
func (p *PayService) GetTransactionStatusById(ctx context.Context, payId int64) (string, error) {
...
func (p *PayService) ReverseTransaction(ctx context.Context, payId int64) error {
